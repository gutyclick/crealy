...
const sections = [
  ...
  { title: "4. Analítica, publicidad, rendimiento y errores", paragraphs: ["Cuando las variables correspondientes están habilitadas, Vercel Analytics y Speed Insights miden visitas, navegación y rendimiento. Sentry recibe errores, trazas y métricas técnicas con la transmisión de información personal predeterminada desactivada.", "Con tu consentimiento, la etiqueta de Google Ads mide visitas y conversiones para que podamos evaluar campañas publicitarias. Puede tratar identificadores técnicos, información del navegador, páginas visitadas y la confirmación de una conversión. No enviamos a Google prompts, imágenes, correos, datos completos de pago, URLs firmadas ni mensajes de soporte."] },
