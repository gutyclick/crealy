...
const sections = [
  ...
  { title: "4. Analítica, publicidad, rendimiento y errores", paragraphs: ["Cuando las variables correspondientes están habilitadas, Vercel Analytics y Speed Insights miden visitas, navegación y rendimiento. Sentry recibe errores, trazas y métricas técnicas con la transmisión de información personal predeterminada desactivada.", "Con tu consentimiento, Google Tag Manager, Google Ads y Meta Pixel miden visitas y conversiones para que podamos evaluar campañas publicitarias. Pueden tratar identificadores técnicos, información del navegador, páginas visitadas y la confirmación de una conversión. No enviamos a Google ni Meta prompts, imágenes, correos, datos completos de pago, URLs firmadas ni mensajes de soporte."] },
  { title: "5. Consentimiento y controles", paragraphs: ["Google Ads y Meta Pixel permanecen desactivados hasta que aceptas la medición opcional. Puedes permitirla o mantener solo las tecnologías necesarias con la misma facilidad, y retirar tu consentimiento en cualquier momento mediante los controles disponibles en esta página. La retirada no afecta el tratamiento realizado previamente.", "La suscripción opcional a novedades es independiente de las cookies y permanece desmarcada por defecto. Puedes darte de baja en cualquier momento sin dejar de recibir comunicaciones necesarias de seguridad, soporte o facturación."] },
