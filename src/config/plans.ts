...
export const PRICING_PLANS: PricingPlan[] = [
  { id: "free", name: "Gratis", description: "Prueba Crealy y crea tus primeros diseños.", monthlyPrice: 0, credits: 3, estimatedUsage: { standard: 3, hd: 1, bannerOrCover: 0 }, features: ["Prueba Crealy sin riesgo", "Herramientas de creación visual", "Calidad adaptada a cada formato", "Sin tarjeta de crédito", "Exportación sencilla"], cta: "Probar Crealy gratis", supportingText: "Sin tarjeta. Empieza a crear en segundos." },
