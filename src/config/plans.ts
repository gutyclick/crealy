...
export const PRICING_PLANS: PricingPlan[] = [
  ...
  { id: "starter", name: "Starter", description: "Para quienes crean contenido de vez en cuando.", monthlyPrice: 5, annualPrice: 48, credits: 10, estimatedUsage: { standard: 10, hd: 3, bannerOrCover: 2 }, features: ["Todas las herramientas de creación", "Miniaturas, posts, banners y covers", "Calidad estándar y HD", "Historial de diseños", "Sin marca de agua", "Uso comercial"], cta: "Empezar", supportingText: "Ideal para proyectos personales y creadores ocasionales." },
