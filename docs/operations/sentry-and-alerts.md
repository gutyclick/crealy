...
El cron `/api/internal/operations/monitor` requiere `Authorization: Bearer CRON_SECRET` y se ejecuta cada diez minutos. Emite issues agrupados y métricas para:
